...
/**
 * A remembered prescriber contact (spec V1.3-F1).
 *
 * Stored locally in the regimen DB (Law 4 — no off-device transmission). Entries are created
 * automatically when a medication is saved with a new prescriber name, and can be edited or
